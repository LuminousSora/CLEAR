...
import math
import CLEAR.model as model
import CLEAR.utils as utils
...
if __name__ == '__main__':
    ...
    run = model.CLEAR(lr=0.001, lr_milestones=[], batch_size=batch_size, epochs=75, rbf=True, a=0.2, device=device)
